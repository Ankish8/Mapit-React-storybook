...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile button component with multiple variants, sizes, and states. Supports icons, loading states, and full customization. ✅ Auto-deployment working!',
      },
    },
  },
  argTypes: {
